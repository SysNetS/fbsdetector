...
message_name = 'nas_eps_nas_msg_emm_type_value'
# message_name = 'lte-rrc_c1_showname'
# Identify unique values in the 'nas_eps_nas_msg_emm_type_value' feature
unique_values = data[message_name].unique()
...
for i in range(len(data) - 1):
    source_node = data.loc[i, message_name]
    target_node = data.loc[i + 1, message_name]
...
model = GCNModel(num_nodes, num_features, num_classes, num_heads)
