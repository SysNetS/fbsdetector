...
#         self.conv1 = SAGEConv(num_features, num_classes, heads=num_heads)
...
model = GraphSAGEModel(num_nodes, num_features, num_classes, num_heads)
...
model_path = os.path.join(models_dir, "msa_graphsage_model_nas.pth")
