...
data = pd.read_csv('../dataset/fbs_nas.csv')
data = pd.read_csv('../dataset/fbs_nas_ext.csv')
...
model = GATModel(num_nodes, num_features, num_classes, num_heads)
